...
@php
    $uuid = 'lara-ui-splitter-' . Str::random(8);
...
<div
    ...
    x-init="
        () => {
            $nextTick(() => {
                HSLayoutSplitter.autoInit(document.getElementById('{{ $uuid }}'));
            });
        }
    "
...
>
    <div
        {{ $attributes->twMerge('flex ' . ($direction === 'vertical' ? 'flex-col' : '') . ' border border-gray-200 rounded-lg dark:border-neutral-700 h-50') }}
