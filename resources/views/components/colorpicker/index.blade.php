@props([
    'uuid' => 'lara-ui-colorpicker-' . Str::random(8),
    'label' => null,
    'hint' => null,
    'showValidation' => true,
])
...
<input type="color" {{ $attributes->twMerge('p-1 h-10 w-14 block bg-white border border-gray-200 cursor-pointer rounded-lg disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700" id="hs-color-input') }} {{ $attributes }}>
